                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="text-left">
                        ...
                        <div className="flex justify-start">
                            <a href="#" className="bg-blue-600 text-white text-lg font-semibold px-8 py-4 rounded-md shadow-lg hover:bg-blue-700 transition duration-300 transform hover:-translate-y-1" data-probat-conversion="true">
                                Fuel Your Business
                            </a>
                        </div>
                    </div>

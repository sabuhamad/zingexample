            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="text-left">
                        ...
                        <p className="mt-6 max-w-lg text-xl text-gray-400 mb-10 leading-relaxed">
                        ...
                        <div className="flex justify-start">
                            <a 
                                ...
                                className="bg-white text-gray-900 text-lg font-semibold px-8 py-4 rounded-md shadow-lg hover:bg-gray-200 transition duration-300 transform hover:-translate-y-1"
                            >
                                Fuel Your Business
                            </a>
                        </div>
                    ...
                    <div className="flex justify-center lg:justify-end relative">
                        ...
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gray-700 rounded-full mix-blend-screen filter blur-3xl opacity-40 animate-blob"></div>

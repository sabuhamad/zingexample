            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="text-left">
                        ...
                        <div className="flex justify-start">
                            <a 
                                ...
                                className="bg-gray-700 text-white text-lg font-semibold px-8 py-4 rounded-md shadow-lg hover:bg-gray-800 transition duration-300 transform hover:-translate-y-1"
                            >
                                Fuel Your Business
                            </a>
                        </div>
                    ...
                    <div className="flex justify-center lg:justify-end relative">
                        {/* Decorative blob behind card - changed to gray */}

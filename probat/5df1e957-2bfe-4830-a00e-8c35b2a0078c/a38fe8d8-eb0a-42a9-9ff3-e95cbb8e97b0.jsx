                    ...
                    <div className="text-left">
                        ...
                        <div className="flex justify-start">
                            <a 
                                ...
                                className="bg-gray-800 text-white text-lg font-semibold px-8 py-4 rounded-md shadow-lg hover:bg-gray-900 transition duration-300 transform hover:-translate-y-1"
                            >
                                Fuel Your Business
                            </a>
                        </div>
